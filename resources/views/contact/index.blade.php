                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('contact.send') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="student_id" id="student_id" class="mt-1 block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="subject" id="subject" class="mt-1 block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('subject') }}" required>
                            @error('subject')
                                <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="message" id="message" rows="6" class="mt-1 block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" required>{{ old('message') }}</textarea>
                            @error('message')
                                <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
